...
class France_Relocation_Assistant {
    ...
    */
    ...
    private function enqueue_shortcode_assets() {
        ...
        wp_enqueue_style(
            'fra-search',
            FRA_PLUGIN_URL . 'assets/css/search.css',
            array(),
            FRA_VERSION
        );
        ...
        wp_enqueue_script(
            'fra-search',
            FRA_PLUGIN_URL . 'assets/js/search.js',
            array(),
            FRA_VERSION,
            true
        );

        // Localize search data for JavaScript
        fra_localize_search_data();
...
require_once FRA_PLUGIN_DIR . 'includes/class-fra-seo-pages.php';
